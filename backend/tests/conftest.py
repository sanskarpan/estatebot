...
def db(tmp_path: Path) -> Database:
    ...
    database.upsert_listing(Listing(source_site="darglobal", source_id="dg1", source_url="https://darglobal.co.uk/dg1", record_type="project", name="DG1", property_category="apartment", location_city="Dubai", location_country="United Arab Emirates", bedrooms="Studios, 1, 2 and 3 bedrooms", bedrooms_min=0, bedrooms_max=3, unit_types_normalized=["studio", "1br", "2br", "3br"], price_currency="AED", description="Luxury apartments in Business Bay with a sky garden and infinity pool."))
