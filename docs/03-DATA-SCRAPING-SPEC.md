...
Implementation note (2026-09-02): the initial rendered result set of the public Projects search yielded 32 canonical detail pages. Their visible DOM is retained as an auditable capture and normalized without authenticated state or challenge bypass. The page advertised 80 results, so 32 is an intentionally bounded snapshot rather than a claim of exhaustive coverage.
