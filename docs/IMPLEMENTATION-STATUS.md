...
**Recorded:** 2026-09-03 (Asia/Kolkata)
...
- GitHub Actions test/container-smoke workflow, best-effort scheduled public health ping, and a container-host configuration that deploys only after CI checks pass.
...
| Current active listings | 248 total: 36 DarGlobal projects, 180 Wasalt sale/rent listings, and 32 Wasalt projects |
...
| Availability ping | Fifteen-minute off-hour workflow is configured; manual and later scheduled runs validated public readiness and the non-empty corpus, with scheduler delays/ skipped slots treated as best-effort limitations |
